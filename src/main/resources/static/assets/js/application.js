...
$(document).ready(function() {
    ...
    // Toggling Sidebars
    // ------------------------------
    $('body').on('click', '#trigger-sidebar>a', function() {
        Utility.toggle_leftbar();
    });

    $('body').on('click', '#trigger-fullscreen', function() {
    ...
    // -------------------------------
    $('body').on('click', '.dropdown-menu a[data-toggle="tab"]', function(e) {
        e.stopPropagation();
        $(this).tab('show');
    ...
    // Panel Collapses
    // -------------------------------
    $('body').on('click', 'a.panel-collapse', function() {
    ...
    // Quick Start
    // -------------------------------
    $('body').on('click', '#headerbardropdown', function() {
        $('#headerbar').css('top', 0);
        return false;
    });

    $('body').on('click', '#headerbardropdown', function(event) {
    ...
    // Search on Top
    // -------------------------------
    $('body').on('click', '#trigger-toolbar-search', function() {
        $("#toolbar-search").toggleClass('active');
        $("#toolbar-search input.form-control").focus();
        $("header#topnav > .toolbar").toggle();
    });

    $('body').on('click', '#toolbar-search .input-group-btn:last-child button', function() {
        $("#toolbar-search").toggleClass('active');
        $("header#topnav > .toolbar").toggle();
    });
