...
public interface UserService {
    ...
    /**
     * Retourne les utilisateurs du tableau spécifié dont le nom + prénom contiennent la chaîne en paramètre
     *
     * @param query chaîne à chercher
     * @param id    id du tableau en cours
     * @return liste des utilisateurs dont le nom + prénom contiennent la chaîne en paramètre
     */
    List<UserDTO> loadUsersFromBoardWithCurrent(String query, Long id);
